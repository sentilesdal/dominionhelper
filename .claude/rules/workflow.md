...
- Before writing any code, create a worktree: `git worktree add .claude/worktrees/<name> -b <branch-name>`
- Use descriptive worktree names matching the feature/fix (e.g., `add-opening-analysis`, `fix-observer-race-condition`)
- After work is complete and the PR is created, clean up the worktree: `git worktree remove .claude/worktrees/<name>`
